...
try {
  ...
  node scripts/ws-lifetime-probe.mjs --live-shadow --live-training --live-training-min-ev=-5 --status=live --channels=odds,scores,status --markets=ML,Totals --eventIds-file=reports/live-preflight-eventIds.txt --lock --duration-minutes=120
