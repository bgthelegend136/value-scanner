...
# Settlement: update completed paper bets and sent Telegram alerts from The Odds
# API scores. Sends nothing to Telegram and never touches the 10% live-alert floor.
